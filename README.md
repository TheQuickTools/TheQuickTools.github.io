...
4. Choose `main` branch and `/quicktools` folder
5. Your site will be live at `https://yourusername.github.io/quicktools/`
...
1. Replace ad placeholders with your AdSense code
2. Each tool page has an `<div class="ad-slot">` ready for ads
3. High-CPC niches included: finance, insurance, AI tools
